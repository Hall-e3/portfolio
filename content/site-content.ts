...
export const defaultContent: SiteContent = {
  ...
  projects: [
    ...
    },
    {
      ...
      desc: "Live web platform delivered end-to-end for a Ugandan client.",
    },
    {
      id: 7,
      title: "Keyjani",
      ...
      status: "Live",
      role: "Frontend · lead",
      link: "https://www.keyjani.com/",
      tech: ["React", "Tailwind CSS"],
      desc: "Property management web app used daily by property managers — listings, tenant tracking, and task management.",
    },
    {
      id: 5,
      title: "Find It",
